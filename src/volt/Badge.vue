...
const theme = ref<BadgePassThroughOptions>({
  root: `inline-flex items-center justify-center rounded-md
        ...
        p-success:bg-[var(--color-status-success)] p-success:text-white
        p-info:bg-[var(--color-status-info)] p-info:text-white
        p-warn:bg-[var(--color-status-warning)] p-warn:text-white
        p-danger:bg-[var(--color-status-danger)] p-danger:text-white
